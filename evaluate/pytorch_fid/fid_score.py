...
parser.add_argument('--path', type=str, nargs=2, required=True,
                    help=('Paths to the generated images or '
                          'to .npz statistic files. The first path is for the '
                          'generated images, the second for the reference images.'))
